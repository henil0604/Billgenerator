...
select.addEventListener('input', () => {
    ...
    if (select.value == "") {
        ...
        <div class="PNQDiv my-2" id="productInfo${i}">
            ...
            <h6 class="text-muted mx-1 my-2">%</h6>
            <h6 class="text-muted mx-5 my-1">Amount</h6>
            <input type="text" class="form-control amount" id="amount${i}" onchange="log('hello')">
            </div>
    `
...
function calc() {
    ...
    for (let i = 0; i < div.length; i++) {
        ...
        // console.log(qty);
        rate = div[i].childNodes[9]
        // console.log(rate);
        gst = div[i].childNodes[13]
        // console.log(gst);
        amount = div[i].childNodes[19]
        // console.log(amount);
...
function total() {
    ...
    location.href = "bill/main.html?dr=vadher"
}
